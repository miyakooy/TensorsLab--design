...
Some examples from `huashu-design` are tightly coupled to that project’s own brand identity, narrative, or demo library. Those should be rebuilt for TensorsLab rather than copied as-is.

## Must rebuild manually

- Any case study or showcase that visually depends on the original huashu brand
- Any demo that references 花叔 / huashu-specific phrasing or identity
- Any landing page or launch animation that uses huashu-specific assets
...
1. Remove huashu-specific wording
